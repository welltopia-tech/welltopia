    ...
    <section className="bg-[#0d2d52] px-5 py-24 text-white md:px-10 md:py-36">
      <div className="mx-auto max-w-2xl text-center">
        ...
        >
          ...
          <h2 className="mb-3 text-[clamp(26px,4vw,44px)] font-medium">可能性の循環</h2>
          <p
          ...
          <p className="mx-auto mb-4 font-light leading-[1.9] text-white/70">
            私たちが目指すのは、誰かの願いが、誰かの知識や技術とつながり、新しい可能性が生まれ続ける社会です。企業の中に眠る資産。生活者が感じている小さな違和感。地域に受け継がれてきた文化。専門家が持つ知識や技術。
          </p>
          <p className="mx-auto font-light leading-[1.9] text-white/70">
